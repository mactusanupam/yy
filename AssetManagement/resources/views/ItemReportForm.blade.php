...
@section('content')
<form class="form-horizontal" role="form" method="POST" action="{{ url('/ItemReport') }}">
{!! csrf_field() !!}
...
echo '<hg1>Item Transaction Report</hg1>';
...
<tr>
	...
	echo "<tr>
     				 ...
     				 "<img src=".'"newdt/images/cal.gif" '. 'onclick="javascript:NewCssCal('. "'ReportTo'".','. "'yyyyMMdd'".','."'dropdown'".')"'. 'style=cursor:pointer/>'.
	  		 		...
	  		 		"<td>".Form::select('Item_Name', $itemname )." </td></tr></table>"; 
