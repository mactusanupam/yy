...
<form class="form-horizontal" role="form" method="POST" action="{{ url('/inventoryoutdata') }}">
...
<style type="text/css">
  ...
  .navbar-static-top {
    ...
    .button{
       ...
       <!--h3!!>{{ Html::image('img/mactus.gif', 'a picture', array('class' => 'thumb')) }} </h3-->
    <h3>Inventory Out</h3><br>

    <table class='table'>
    
    <!--th><td colspan="8">Inventory Out</th-->
    <tr>
    ...
    <tr id="reference_tr" style="text-align: left; font-weight: bold;">
       ...
       <td colspan ="2" style="text-align:left;"><div id="btnwrap">
        ...
        <!--td > <a  href="{{ url('/conferm') }}" class="btn btn-primary" type ="button">Conferm</a></td>
    ...
    if(item != "" && quantity != "" && price != "") {
        ...
        html += "<td colspan= 3 style= text-align:right>Quantity: </td><td><input type = 'Text' name = 'Quantity[]' id='quantity"+items+"'></td>";
