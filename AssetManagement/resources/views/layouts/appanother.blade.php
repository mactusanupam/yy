    ...
    <nav class="navbar navbar-default navbar-static-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <!-- Collapsed Hamburger -->
                {{ Html::image('img/mactus.gif', 'a picture', array('class' => 'thumb')) }}
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="{{ url('/project') }}">Project Worksheet</a></li>

                                <li><a href="{{ url('/ApplyLeave') }}">Leave</a></li>

                                <li><a href="{{ url('/PdfReport1') }}">Report</a></li>

                                <li><a href="{{ url('/accreader') }}">Access Reader</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="{{ url('/underdevelopment') }}">Financial Management</a></li>

                                <li><a href="{{ url('/underdevelopment') }}">Procurement Process</a></li>

                                <li><a href="{{ url('/AppraisalPage') }}">Appraisal Management</a></li> 

                                <!--<li><a href="{{ url('/filterdate') }}">Service Log Report</a></li>-->

                               
                            </ul>
                        </li>
                   <!-- <li><a href="{{ url('/Admin') }}"><h2>Admin</h2></a></li>
                    <li><a href="{{ url('/chart') }}"><h2>Modules</h2></a></li>-->

                 </ul>
                 <ul class="nav navbar-nav navbar-top">
                 <li><a><h1><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Mactus Management System<h1></a></li>
                 </ul>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @else
                         ...
                         <ul class="nav navbar-nav navbar-down">
                                ...
                                <li><a href="{{ url('/chart') }}"><h2>Chart</h2></a></li>
                        </ul>
